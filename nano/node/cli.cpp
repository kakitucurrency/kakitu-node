...
void nano::add_node_options (boost::program_options::options_description & description_a)
{
	...
	("network", boost::program_options::value<std::string> (), "Use the supplied network (live, test or dev)")
...
std::error_code nano::handle_node_options (boost::program_options::variables_map const & vm)
{
	...
	else if (vm.count ("generate_config"))
	{
		...
		if (valid_type)
		{
			std::cout << "# This is an example configuration file for Kakitu. Visit https://kakitu.org for more information.\n#\n"
					  ...
					  << "# Additional information for notable configuration options is available in https://kakitu.org\n";
