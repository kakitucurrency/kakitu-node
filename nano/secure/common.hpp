...
public:
	...
	nano::account kshs_beta_account;
	nano::account kshs_live_account;
	nano::account kshs_test_account;
	std::shared_ptr<nano::block> kshs_dev_genesis;
	std::shared_ptr<nano::block> kshs_beta_genesis;
	std::shared_ptr<nano::block> kshs_live_genesis;
	std::shared_ptr<nano::block> kshs_test_genesis;
	std::shared_ptr<nano::block> genesis;
	nano::uint128_t genesis_amount;
	nano::account burn_account;
	nano::account kshs_dev_final_votes_canary_account;
	nano::account kshs_beta_final_votes_canary_account;
	nano::account kshs_live_final_votes_canary_account;
	nano::account kshs_test_final_votes_canary_account;
	nano::account final_votes_canary_account;
	uint64_t kshs_dev_final_votes_canary_height;
	uint64_t kshs_beta_final_votes_canary_height;
	uint64_t kshs_live_final_votes_canary_height;
	uint64_t kshs_test_final_votes_canary_height;
